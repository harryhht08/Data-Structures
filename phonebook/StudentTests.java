...
/*
    // My own tests
    private int hashWithSize(String key, int tableSize) {
    ...
    @Test
    public void test01() {
        QuadraticProbingHashTable sc = new QuadraticProbingHashTable(true);
        ...
        System.out.println(sc.size() + " " + sc.capacity());
